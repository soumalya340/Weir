...
/**
 * @notice Shared weir v2 interfaces: fee escrow, fee policy, and the launch
...
/**
 * @notice Minimal ERC-721 receiver signature used by WeirV2LaunchLocker to
...
/**
 * @notice Record kept by WeirV2LaunchFactory for every launch, readable by
 * the locker and by off-chain indexers.
 */
interface IWeirV2LaunchFactory {
