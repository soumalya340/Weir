...
/**
 * @title WeirV2LauncherToken
 * @notice Fixed-supply ERC-20 deployed by WeirV2LaunchFactory for a v2 launch.
 ...
 * locked into `WeirV2BuybackVault` for a five-year vest instead of being
 * burned.
 */
contract WeirV2LauncherToken is ERC20, ERC20Burnable {
    struct Socials {
        string twitter;
        string telegram;
        string discord;
    ...
    constructor(
        ...
        // deploys this token indirectly through WeirV2LaunchDeployer to keep its
